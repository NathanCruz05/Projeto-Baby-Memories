    ...
    const handleChangePassword = async () => {
        ...
        try {
            ...
            if (error.code === 'auth/requires-recent-login') {
                errorMessage = 'Por favor, faça login novamente para alterar sua senha por segurança.';
        ...
        <View style={estilos.container}>
            ...
            <View style={{ marginTop: 30, paddingHorizontal: 30 }}>
                ...
                <View style={estilos.section}>
                    ...
                    />
                    <Pressable style={estilos.botao} onPress={handleChangeName} disabled={loading}>
                        {loading ? <ActivityIndicator color="#fff" /> : <Text style={estilos.botaoText}>Salvar Nome</Text>}
                    </Pressable>
                </View>
                ...
                <View style={estilos.section}>
                    ...
                    />
                    <Pressable style={estilos.botao} onPress={handleChangePassword} disabled={loading}>
                        {loading ? <ActivityIndicator color="#fff" /> : <Text style={estilos.botaoText}>Salvar Senha</Text>}
                    </Pressable>
                </View>

                <View style={estilos.section}>
                    <Text style={estilos.sectionTitle}>Sair da Conta</Text>
                    <Pressable style={[estilos.botao, estilos.logoutButton]} onPress={handleLogout} disabled={loading}>
                        {loading ? <ActivityIndicator color="#fff" /> : <Text style={estilos.botaoText}>Sair</Text>}
                    </Pressable>
                </View>
            </View>
        </View>
